...
import { Settings, CheckCircle, LayoutGrid } from "lucide-react";
       ...
       return (
         <div className="fixed inset-0 w-full h-full bg-neutral-900 overflow-hidden text-white">
           <div className="absolute top-6 left-1/2 -translate-x-1/2 z-60">
             ...
             >
               <LayoutGrid size={16} className="text-gray-300" /> 返回作品流</button>
           </div>
          ...
          !apiKey ? (
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none flex flex-col items-center justify-center select-none w-full max-w-2xl mt-[-5vh]">
              ...
              <div className="flex flex-col items-center bg-[#121212]/60 backdrop-blur-xl p-10 rounded-[32px] border border-white/10 shadow-[0_20px_60px_rgba(0,0,0,0.5)] max-w-lg text-center relative pointer-events-auto">
                ...
                <div className="w-16 h-16 rounded-2xl bg-linear-to-tr from-yellow-400/20 to-orange-500/20 border border-yellow-500/30 flex items-center justify-center mb-6 shadow-inner">
                   <Settings size={32} className="text-yellow-400 drop-shadow-[0_0_12px_rgba(250,204,21,0.6)]" />
                </div>
                ...
                <p className="text-gray-400 text-sm leading-relaxed mb-8 max-w-sm">
                  这是您的无限 AI 创作工作站。第一步，请先配置您的专属 API 密钥，以启用所有 AI 模型生成能力。                </p>
                ...
                >
                  <div className="absolute inset-0 bg-linear-to-r from-yellow-300 via-yellow-100 to-yellow-300 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                  <Settings size={18} className="relative z-10 text-black/80 group-hover:rotate-90 transition-transform duration-500" />
                  <span className="relative z-10">立即设置 API Key</span>
                </button>
                <div className="mt-6 flex flex-col items-center">
                  ...
                  <p className="mt-2 text-xs text-gray-400">扫码添加微信，获取使用支持</p>
                </div>
              </div>
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none text-center select-none">
              <h1 className="text-4xl font-light text-gray-700 tracking-[0.3em] uppercase opacity-20">
                Nano Banana Pro
              </h1>
            </div>
          )
